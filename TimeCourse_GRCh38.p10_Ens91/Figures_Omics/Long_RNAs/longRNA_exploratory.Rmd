...
png("Figure_Output/Single_Genes/Paper/longRNA_glia-marker.png", width=9, height=9, units="in", res=300)
ggplot(meltSE(se, g3, assayName = "logcpm"), aes(as.factor(day), logcpm)) + geom_violin() + facet_wrap(~feature, scale="free") +
geom_point(aes(color = experiment)) + xlab("Day") + theme_classic()
dev.off()
