...
pdf("./Figure_Output/Human_Specific_miRs.pdf", width=6.5, height=5)
pp
dev.off()
```
...
```{r}
#Source data Fig. 2c
ll <- df[,c("day","logcpm","conservation","feature","experiment")]
write.csv(ll,file = "../../../12_SourceData/Fig2/Fig_2c.csv")
```
