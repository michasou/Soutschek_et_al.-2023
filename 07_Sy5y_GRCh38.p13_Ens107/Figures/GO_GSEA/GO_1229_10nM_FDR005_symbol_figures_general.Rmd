...
p1 <- ggplot(data = GO, aes(x = as.factor(GO$GO.ID))) +
  ...
  geom_label(label = GO$label2, y = 22.5,label.size = 5, colour = NA, fill = "#636363") +
  geom_text(aes(label = round(GO$Fold_Enrichment,2), y = 22.5), colour = "white") +
  geom_text(aes(label = GO$Info),y = 5, hjust = "left", colour = "black") +
  scale_y_continuous(limits = c(-20,25), name = "Number of Genes")+ 
  ...
  annotate("label", x = 15.9, y = 22.5,colour = NA,label = "Enrichment", fill = "#636363") +
  annotate("text", x = 15.9, y = 22.5,label= "Enrichment",colour = "white") +
...
ggsave("../Figure_Output/GO-Terms/GO_10nmDEA_symbol_005.png",p1, width=12, height=7, units="in", dpi=300)
```
...
p2 <- ggplot(data = CC_Top, aes(x = as.factor(CC_Top$GO.ID))) +
  ...
  geom_label(label = CC_Top$label2, y = 22.5,label.size = 5, colour = NA, fill = "#636363") +
  geom_text(aes(label = round(CC_Top$Fold_Enrichment,2), y = 22.5), colour = "white") +
  scale_y_continuous(limits = c(-20,25), name = "Number of Genes")+ 
  coord_flip(clip = "off", xlim = c(1,15)) +
  annotate("label", x = 15.9, y = 0,colour = NA,label = "P.Value", fill = "#636363") +
  annotate("text", x = 15.9, y = 0,label= "P.Value",colour = "white") +
...
ggsave("../Figure_Output/GO-Terms/GO_10nmDEA_symbol_005_CC.pdf",p2, width=12, height=7, units="in", dpi=300)
```
