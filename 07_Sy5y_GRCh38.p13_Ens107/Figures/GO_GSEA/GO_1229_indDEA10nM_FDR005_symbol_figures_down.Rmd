...
#Import
```{r}
CC <- readRDS("../../longRNA_R/GO_Terms_indDEA/GOdata/GO_1229_CC_sig_005_down_symbol_elim.rds")
MF <- readRDS("../../longRNA_R/GO_Terms_indDEA/GOdata/GO_1229_MF_sig_005_down_symbol_elim.rds")
BP <- readRDS("../../longRNA_R/GO_Terms_indDEA/GOdata/GO_1229_BP_sig_005_down_symbol_elim.rds")
```
...
p <- ggplot(data = GO, aes(x = as.factor(GO$GO.ID))) +
  ...
  geom_text(aes(label = GO$Info),y = -8, hjust = "left", colour = "#4a4a4a") +
  scale_y_continuous(limits = c(-7.25,25), name = "Number of Genes", breaks = c(0, 5, 10, 15, 20, 25))+ 
...
ggsave("../Figure_Output/GO-Terms/GO_indDEA_symbol_down_005.png", plot = p, width=12, height=5, units="in", dpi=300)
```
