...
p <- ggplot(data = GO, aes(x = as.factor(GO$GO.ID))) +
  ...
  geom_text(aes(label = GO$Info),y = -7, hjust = "left", colour = "#4a4a4a") +
  scale_y_continuous(limits = c(-6.25,25), name = "Number of Genes")+ 
...
ggsave("../Figure_Output/GO-Terms/GO_indDEA_symbol_down_005.png", width=12, height=5, units="in", dpi=300)
```
