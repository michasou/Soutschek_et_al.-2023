...
se$cond_name2 <- gsub("_20pmol"," 10nM",se$cond_name2)
se$cond_name2 <- gsub("_40pmol"," 20nM",se$cond_name2)
se$cond_name2 <- gsub("NegCtrl","Neg. Ctrl",se$cond_name2)
se$cond_name2 <- factor(se$cond_name2,levels = c("Neg. Ctrl","miR 10nM","miR 20nM"))
```
...
p1 <- ggplot(df, aes(x = x, y = y)) +
  ...
  guides(color=guide_legend(title="Condition"),shape=guide_legend(title="Replicate"))
