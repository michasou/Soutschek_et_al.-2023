...
```{r}
# plot Volcano
p <- plotVolcano_new(df = dea1229 , text.size = 12, sig = 0.05, anno = NULL, colors = c(yellow,blue,grey),
...
ggsave(p,filename = "../Figure_Output/Volcanos/dea1229_10nM.pdf", width = 4.5, height = 3.5)
```
