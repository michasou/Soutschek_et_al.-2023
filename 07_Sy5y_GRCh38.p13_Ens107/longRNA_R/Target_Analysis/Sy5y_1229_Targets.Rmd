...
sites1229 <- readRDS("../../../03_pLNA_GRCh38.p13_Ens107/pLNA_experiment/Target_Analysis/miR1229/target_data/Screen_mir-1229-3p_sites_agg.rds")
...
sites1229agg <- sites1229filtered %>%
  group_by(gene_id) %>%
  dplyr::filter(repression == min(repression, na.rm=TRUE))
