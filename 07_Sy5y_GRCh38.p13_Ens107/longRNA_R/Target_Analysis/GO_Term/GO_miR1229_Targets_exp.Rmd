...
# dea_plna <- read.csv("Y:/Michael/07-_Workflow/02-_Human specific miRNAs project/Soutschek_et_al_PaperScripts/03_pLNA_GRCh38.p13_Ens107/pLNA_experiment/Target_Analysis/miR1229/target_data/dea1229_targets_genebased.csv")
...
#Create the Vectors
```{r}
GeneUniverse <- as.character(dea1229g$gene_name)
GenesOfInterest <- as.character(Targets$gene_name)
...
#saveRDS
```{r}
saveRDS(tabBPE, file = "./GO_data/GO_BP_miR1229_Targets_10nM_expr_elim_005.rds")
saveRDS(tabMFE, file = "./GO_data/GO_MF_miR1229_Targets_10nM_expr_elim_005.rds")
saveRDS(tabCCE, file = "./GO_data/GO_CC_miR1229_Targets_10nM_expr_elim_005.rds")
```
...
# ExcelFile <- list("GO_BP_ordered by Fisher" = tabBPF, "GO_BP_ordered by Elim" = tabBPE, "GO_MF_ordered by Fisher" = tabMFF,
#                   "Go_MF_ordered by Elim" = tabMFE, "GO_CC_ordered by Fisher" = tabCCF, "GO_CC_ordered by  Elim" = tabCCE)
```


#To correctly locate the zip.exe for Rtools to write the Excel-File
```{r}
# Sys.setenv("R_ZIPCMD" = "C:/Users/michasou/Documents/R3/Rtools/bin/zip.exe")
# 
# write.xlsx(ExcelFile, file = "GO_CB_Comp.xlsx")
```
