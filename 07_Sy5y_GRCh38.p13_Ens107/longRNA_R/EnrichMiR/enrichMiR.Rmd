...
ggsave2("../../Figures/Figure_Output/EnrichMiR/miR1229_Enrichplot_SO_10nM.pdf",p4a, width = 7,height = 5, bg = "white")
```

```{r}
#Source data Fig. 6b)
write.csv(res_SC_ind10_so,"../../../12_SourceData/Fig6/Fig_6b.csv")
```
...
ggsave2("../../Figures/Figure_Output/EnrichMiR/miR1229_10nM_CDPlot_SC.pdf",p10, width = 6,height = 4.5, bg = "white")
```
