...
#mir
se_short <- readRDS("../../../TimeCourse/smallRNA/data/Small_RNA/smallRNA_oasis.DEA.SE.rds")
...
```{r}
e_TS <- testEnrichment(dea1,sets = sets_TSall,tests = c("areamir","siteoverlap"), sets.properties = miRs)
res_TS_area <- getResults(e_TS,test = c("areamir"),flatten = TRUE)
res_TS_so <- getResults(e_TS,test = c("siteoverlap.down"),flatten = TRUE)
```

# enrichMiR ind_DEA 10nM (miR-1229 only present in TSall)
```{r}
e_TS_ind10 <- testEnrichment(dea2,sets = sets_TSall,tests = c("areamir","siteoverlap"), sets.properties = miRs)
res_TS_ind10_area <- getResults(e_TS_ind10,test = c("areamir"),flatten = TRUE)
res_TS_ind10_so <- getResults(e_TS_ind10,test = c("siteoverlap.down"),flatten = TRUE)
```

# enrichMiR ind_DEA 20nM (miR-1229 only present in TSall)
```{r}
e_TS_ind20 <- testEnrichment(dea3,sets = sets_TSall,tests = c("areamir","siteoverlap"), sets.properties = miRs)
res_TS_ind20_area <- getResults(e_TS_ind20,test = c("areamir"),flatten = TRUE)
res_TS_ind20_so <- getResults(e_TS_ind20,test = c("siteoverlap.down"),flatten = TRUE)
```
...
```{r}
#siteoverlap
p1 <- enrichPlot(res = res_TS_so,enr.field = "enrichment",col.field = "props",sig.field = "FDR",label.field = "members", size.field = "overlap", label.sig.thres = 0.001)
p1 <- p1 + scale_color_viridis_c(direction = 1) + theme_classic() + theme(plot.title = element_text(size=15), axis.text=element_text(size=12), axis.title=element_text(size=14),legend.title=element_text(size=13), legend.text=element_text(size=12)) + ggtitle("Targetscan all - areamir") + labs(color="Expression")

#areamir
p2 <- enrichPlot(res = res_TS_area,enr.field = "enrichment",col.field = "props",sig.field = "FDR",label.field = "members", size.field = NULL, label.sig.thres = 0.051)
p2 <- p2 + scale_color_viridis_c(direction = 1) + theme_classic() + theme(plot.title = element_text(size=15), axis.text=element_text(size=12), axis.title=element_text(size=14),legend.title=element_text(size=13), legend.text=element_text(size=12)) + ggtitle("Targetscan all - areamir") + labs(color="Expression")
...
```{r}
#siteoverlap
p4 <- enrichPlot(res = res_TS_ind10_so,enr.field = "enrichment",col.field = "props",sig.field = "FDR",label.field = "members", size.field = "overlap", label.sig.thres = 0.001)
...
#areamir
p5 <- enrichPlot(res = res_TS_ind10_area,enr.field = "enrichment",col.field = "props",sig.field = "FDR",label.field = "members", size.field = NULL, label.sig.thres = 0.051)
...
```{r}
#siteoverlap
p7 <- enrichPlot(res = res_TS_ind20_so,enr.field = "enrichment",col.field = "props",sig.field = "FDR",label.field = "members", size.field = "overlap", label.sig.thres = 0.001)
p7 <- p7 + scale_color_viridis_c(direction = 1) + theme_classic() + theme(plot.title = element_text(size=15), axis.text=element_text(size=12), axis.title=element_text(size=14),legend.title=element_text(size=13), legend.text=element_text(size=12)) + ggtitle("Targetscan all - areamir") + labs(color="Expression")

#areamir
p8 <- enrichPlot(res = res_TS_ind20_area,enr.field = "enrichment",col.field = "props",sig.field = "FDR",label.field = "members", size.field = NULL, label.sig.thres = 0.051)
p8 <- p8 + scale_color_viridis_c(direction = 1) + theme_classic() + theme(plot.title = element_text(size=15), axis.text=element_text(size=12), axis.title=element_text(size=14),legend.title=element_text(size=13), legend.text=element_text(size=12)) + ggtitle("Targetscan all - areamir") + labs(color="Expression")
