...
sechm::sechm(se2, dd , assayName ="log2FC.Ctrl", top_annotation="diff", gaps_at="condition" ,breaks=TRUE, show_rownames = TRUE, anno_colors = ancols, hmcols = heatcol, annocol_title_side=NA, do.scale = FALSE,sortRowsOn=NULL, cluster_rows=FALSE, 
             name = "scaled\nexpression", row_title = "Genes in the GO:0140896 - cGAS/STING signaling pathway")
dev.off()
```
