...
snps <- vcfR::read.vcfR("../../data/Results_SNPs.bcf.gz", convertNA  = TRUE)
```
...
```{r}
col_info <- read.csv("V:/Michael/Bioinformatics/Internal_Data/2022_soutschek_Ngn2pLNAs_Human_polyARNA/11_2022/Sequencing_RNA_Samples_DNase_Randomization_summary.csv")
...
p1 <- ggplot(dfl, aes(condition,SNP_prob)) +
  ...
  ylab("Inv. probability of\nreference genotype") +
  scale_color_manual(values = col_vec) +
  guides(color=guide_legend(title="Diff.")) +
  xlab("") +
  coord_cartesian(ylim = c(NA,15)) +  theme_classic() + 
