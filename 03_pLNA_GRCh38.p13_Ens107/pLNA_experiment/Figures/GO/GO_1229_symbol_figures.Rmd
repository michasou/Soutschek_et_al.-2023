...
p1 <- ggplot(data = CC_Top, aes(x = as.factor(CC_Top$GO.ID))) +
  ...
  ggtitle("Top15 Cellular Component (FDR < 0.5)") +
  theme_classic() +
...
ggsave("../Figure_Output/GO-Terms/GO_1229_CC_symbol_FDR05.png",p1, width=14, height=6, units="in", dpi=300)
```
...
p2 <- ggplot(data = BP_Top, aes(x = as.factor(BP_Top$GO.ID))) +
  ...
  geom_text(aes(label = label_scientific(digits = 2)(BP_Top$Fisher.elim), y = 0), colour = "white") +
...
# ggsave("../Figure_Output/GO-Terms/GO_1229_BP_symbol_FDR05.png",p2, width=13, height=6, units="in", dpi=300)
ggsave("../Figure_Output/GO-Terms/GO_1229_BP_symbol_FDR05.pdf",p2, width=11.5, height=6)
```
...
#Source data Fig. 4c
ll_sd <- BP_Top
ll_sd$Sig_Genes <- as.character(ll_sd$Sig_Genes)
write.csv(ll_sd,file = "../../../../12_SourceData/Fig4/Fig_4c.csv")
```
...
# p3
# 
# ggsave("../Figure_Output/GO-Terms/GO_1229_MF_symbol_FDR05.png",p3, width=14, height=6, units="in", dpi=300)
```
