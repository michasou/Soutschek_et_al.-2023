...
#saveRDS
```{r}
saveRDS(tabBPE, file = "./GOdata/GO_UP_1229_BP_sig_P005_symbol_elim.rds")
saveRDS(tabMFE, file = "./GOdata/GO_UP_1229_MF_sig_P005_symbol_elim.rds")
saveRDS(tabCCE, file = "./GOdata/GO_UP_1229_CC_sig_P005_symbol_elim.rds")
```
