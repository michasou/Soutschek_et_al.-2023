...
GenesOfInterest <- as.character(dea1229[dea1229$FDR < 0.5,"Symbol"])
...
#saveRDS
```{r}
saveRDS(tabBPE, file = "./GOdata/GO_1229_BP_sig_05_symbol_elim.rds")
saveRDS(tabMFE, file = "./GOdata/GO_1229_MF_sig_05_symbol_elim.rds")
saveRDS(tabCCE, file = "./GOdata/GO_1229_CC_sig_05_symbol_elim.rds")
```
