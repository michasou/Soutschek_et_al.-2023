...
```{r}
GeneUniverse <- as.character(dea181c$Ensembl)
GenesOfInterest <- as.character(dea181c[dea181c$FDR < 0.5,"Ensembl"])
...
#saveRDS
```{r}
saveRDS(tabBPE, file = "./GOdata/GO_181c_BP_sig_05_ensembl_elim.rds")
saveRDS(tabMFE, file = "./GOdata/GO_181c_MF_sig_05_ensembl_elim.rds")
saveRDS(tabCCE, file = "./GOdata/GO_181c_CC_sig_05_ensembl_elim.rds")
```
