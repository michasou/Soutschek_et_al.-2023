...
#script executed with org.Hs.eg.db (version 3.17)
...
GenesOfInterest <- as.character(dea1229[dea1229$PValue < 0.05 & dea1229$logFC > 0,"Ensembl"])
...
#saveRDS
```{r}
saveRDS(tabBPE, file = "./GOdata/GO_UP_1229_BP_sig_P005_ensembl_elim.rds")
saveRDS(tabMFE, file = "./GOdata/GO_UP_1229_MF_sig_P005_ensembl_elim.rds")
saveRDS(tabCCE, file = "./GOdata/GO_UP_1229_CC_sig_P005_ensembl_elim.rds")
```
