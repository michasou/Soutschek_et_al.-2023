...
#load data
```{r}
dea1229g <- read.csv("./target_data/dea1229_targets_genebased.csv")
targets <- dea1229g[dea1229g$PValue < 0.05 & dea1229g$logFC > 0,]
targets <- targets[targets$X8mer > 0 | targets$X7mer > 0,]
Targets <- targets[!is.na(targets$gene_id),]
```
...
#saveRDS
```{r}
saveRDS(tabBPE, file = "./GO_data/GO_BP_miR1229_Targets_elim.rds")
saveRDS(tabMFE, file = "./GO_data/GO_MF_miR1229_Targets_elim.rds")
saveRDS(tabCCE, file = "./GO_data/GO_CC_miR1229_Targets_elim.rds")
```
