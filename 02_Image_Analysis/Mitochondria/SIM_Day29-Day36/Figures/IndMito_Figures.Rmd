...
ggsave2("../Figure_Output/SIM_MitoArea_excl.png",p1, width = 7,height = 4.75, bg = "white")
```
...
ggsave2("../Figure_Output/SIM_MitoArea_Day36.png",p1b, width = 5,height = 4.75, bg = "white")
```
...
ggsave2("../Figure_Output/SIM_MitoLength.png",p2, width = 5.5,height = 4.75, bg = "white")
ggsave2("../Figure_Output/SIM_MitoLength.pdf",p2, width = 5.5,height = 4.75, bg = "white")
```

```{r}
p2a <- p2 + coord_cartesian(ylim = c(0.7,1.25)) + theme(legend.position = "right")
ggsave2("../Figure_Output/SIM_MitoLength_zoom.png",p2a, width = 7,height = 4.75, bg = "white")
```
