...
ggsave2("../Figures/SIM_MitoArea_excl.png",p1, width = 7,height = 4.75, bg = "white")
```
...
ggsave2("../Figures/SIM_MitoArea_Day36.png",p1b, width = 5,height = 4.75, bg = "white")
```
...
ggsave2("../Figures/SIM_MitoLength.pdf",p2, width = 5.5,height = 4.75, bg = "white")
```
