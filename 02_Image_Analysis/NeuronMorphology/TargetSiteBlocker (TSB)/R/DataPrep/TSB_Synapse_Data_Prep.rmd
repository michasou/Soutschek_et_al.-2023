...
syn_res$Synapses_perArea_um2 <- syn_res$SynapseCounts / syn_res$DendriteArea_um2
```
...
syn_res$PSD_per_area_um2 <- syn_res$Count_PSDMaskByDEND / syn_res$DendriteArea_um2
...
syn_res$Syn_per_area_um2 <- syn_res$Count_SynMaskByDend /syn_res$DendriteArea_um2
...
p1 <- ggplot(syn_res,aes(x = Condition, y = sqrt(Synapses_perArea_um2))) + 
...
p2 <- ggplot(syn_res,aes(x = Condition, y = sqrt(PSD_per_area_um2))) + 
  geom_violin(show.legend = FALSE) +
  stat_summary(
    fun = mean,
    geom="crossbar",
...
p3 <- ggplot(syn_res,aes(x = Condition, y = sqrt(Syn_per_area_um2))) + 
  geom_violin(show.legend = FALSE) +
  stat_summary(
    fun = mean,
    geom="crossbar",
...
p4a <- ggplot(syn_res,aes(x = Differentiation, y = DendriteArea_um2)) + 
  geom_violin(show.legend = FALSE) +
  stat_summary(
    fun = mean,
    geom="crossbar",
...
p4b <- ggplot(syn_res,aes(x = Condition, y = DendriteArea_um2)) + 
  geom_violin(show.legend = FALSE) +
  stat_summary(
    fun = mean,
    geom="crossbar",
...
p4c <- ggplot(syn_res,aes(x = Condition, y = DendriteArea_um2)) + 
  geom_violin(show.legend = FALSE) +
  stat_summary(
    fun = median,
    geom="crossbar",
