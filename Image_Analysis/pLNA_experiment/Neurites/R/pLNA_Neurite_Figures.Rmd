...
st_df_med$y_adj <- rep(c(0,0,3.5,0))
...
ggsave2("../Figures/pLNA_Length.png",gt1, width = 8,height = 6.5, bg = "white")
```
...
ggsave2("../Figures/pLNA_BranchEnds.png",gt10, width = 8,height = 6.5, bg = "white")
```
...
ggsave("../Figures/pLNA_SecBranches_normtoCtrl.png",gt11, width = 8,height = 5.5, bg = "white")
