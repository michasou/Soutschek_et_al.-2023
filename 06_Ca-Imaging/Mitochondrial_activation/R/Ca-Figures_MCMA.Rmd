...
ee$pLNA <- sapply(strsplit(as.character(ee$Condition),"_"),"[",1)
ee$pLNA <- factor(ee$pLNA,levels = c("pLNA-Ctrl","pLNA-1229"))
ee$drug <- sapply(strsplit(as.character(ee$Condition),"_"),"[",2)
ee$drug <- factor(ee$drug,levels = c("MC","MA"))
