...
#plgINS is private, here the function info:
```{r}
# plgINS::getMsigSets
# function (species = "Homo sapiens", collections = c("H", "C2", 
#     "C5")) 
# {
#     library(msigdbr)
#     m <- msigdbr(species)
...
# }
# 
# plgINS::goseq.enrichment
# function (allGenes, deGenes, gotype = c("GO:BP", "GO:MF", "GO:CC"), 
