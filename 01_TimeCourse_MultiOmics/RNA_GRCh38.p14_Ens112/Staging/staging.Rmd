...
### Paper main figure
```{r}
h1 <- Heatmap(ccsr_li, col = colors, cluster_rows = FALSE, cluster_columns = FALSE, name="Spearman rank", column_title="Spearman correlation rank", row_names_gp=gpar(fontsize=10), row_title="Lin et al., Stem Cell Rep. 2021", heatmap_legend_param = list(direction = "horizontal"),
...
pdf("./FigureOutput/Main_Lin.pdf", width=4, height=6)
draw(h1,heatmap_legend_side = "bottom"
)
dev.off()
...
pdf("./FigureOutput/Main_Trevino.pdf", width=4.5, height=6)
draw(h2,heatmap_legend_side = "bottom")
dev.off()
```
