...
## input/output files
input <- "../data/Small_RNA/smallRNA_oasis.DEA.SE.rds"
output <- "../data/Small_RNA/smallRNA_oasis.DEA.SynCoClust_Shift.SE.rds"
```
...
```{r}
syn.res <- readRDS("../../../02_Image_Analysis/NeuronMorphology/TimeCourse/Synapse_Quantification/R/Synapsecluster_Result_with_anno.rds")
