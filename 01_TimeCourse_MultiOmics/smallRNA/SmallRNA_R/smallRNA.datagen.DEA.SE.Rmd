...
## input/output files
input <- "../data/raw/smallRNA_oasis.raw.SE.rds"
output <- "../data/smallRNA_oasis.DEA.SE.rds"
output.no_round <- "../data/smallRNA_oasis_noRound.DEA.SE.rds"
```
