...
sechm(se2, cluster2_5, assayName = "corrected", do.scale=TRUE, top_annotation = c("day"), breaks=0.99, column_title="(5) late up",hmcols = heatcol, anno_colors = ancols,annocol_title_side=NA,name = "scaled\nexpression",show_rownames = TRUE)
dev.off()
```
