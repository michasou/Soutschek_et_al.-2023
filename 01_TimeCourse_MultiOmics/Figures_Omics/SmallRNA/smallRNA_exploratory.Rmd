...
png("Figure_Output/Single_miRNAs/Mouse_micro_example1.png", width=7, height=6, units="in", res=300)
ggplot(meltSE(se, g1, assayName = "logcpm"), aes(as.factor(day), logcpm)) + geom_violin() + facet_wrap(~feature, scale="free") + geom_point(aes(color = experiment)) + scale_color_manual(values = col_vec) + theme_classic()
dev.off()
```
