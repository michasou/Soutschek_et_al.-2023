...
ggplot(meltSE(se, g1, assayName = "logcpm"), aes(as.factor(day), logcpm)) + geom_violin() + facet_wrap(~feature, scale="free") + geom_point(aes(color = experiment)) + xlab("Day") + theme_classic() + scale_color_manual(values = col_vec)
dev.off()
...
geom_point(aes(color = experiment)) + xlab("Day") + theme_classic() + scale_color_manual(values = col_vec)
dev.off()
...
# geom_point(aes(color = experiment)) + xlab("Day") + theme_classic() + coord_cartesian(ylim = c(0,NA)) + scale_color_manual(values = col_vec)
# dev.off()
