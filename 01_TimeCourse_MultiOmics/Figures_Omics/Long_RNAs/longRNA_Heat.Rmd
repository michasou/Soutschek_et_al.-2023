...
a <- sechm(lncRNA.se, sig_all_01, top_annotation =c("day"), assayName = "log2FC.neur", gaps_at = "day", breaks=TRUE, show_rownames = FALSE, hmcols = heatcol, anno_colors = ancols, show_colnames = FALSE, column_title = "lncRNA", name = "logFC", annocol_title_side=NA, cluster_rows = TRUE, show_row_dend = FALSE)
...
# all days, normalized Day9
a <- sechm(mRNA.se, sig_plot, top_annotation =c("day"), assayName = "log2FC.neur", gaps_at = "day", breaks=TRUE, show_rownames = FALSE, hmcols = heatcol, anno_colors = ancols, show_colnames = FALSE, column_title = "mRNA", name = "logFC", annocol_title_side=NA, cluster_rows = TRUE, show_row_dend = FALSE)
