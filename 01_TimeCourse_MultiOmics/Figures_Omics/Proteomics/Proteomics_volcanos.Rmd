...
for(i in dea.names){
  df <- rowData(se)[[i]]
  p <- plotVolcano_new(df = df, text.size = 12, sig = 0.05,log.base = 10,anno = NULL, 
                        xlim_min = -10,  xlim_max = 10, ylim_max = 6, padding = 0.5,
...
p1 <- plotVolcano_new(df = df1, text.size = 12, sig = 0.05,
